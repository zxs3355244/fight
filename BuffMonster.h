#ifndef _BUFFMONSTER_H_
#define _BUFFMONSTER_H_
#include "Uint.h"
#include "CvsFile.h"
class BuffMonster :public Uint
{
public:

	BuffMonster();
	~BuffMonster();
	static BuffMonster* create(string name, int id,bool isBoss,int wave,bool showEff);
